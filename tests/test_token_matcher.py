...
class TestTokenMatcherInit:
    def test_missing_ouro_tokenizer_raises(self):
...
class TestRoundTrip:
    def test_ouro_round_trip(self, matcher):
    ...
    def test_hrm_round_trip(self, matcher):
    ...
    def test_special_tokens_crosswalk(self, matcher):
    ...
    def test_map_sequence_empty_encode(self, matcher):
